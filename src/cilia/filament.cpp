...
void filament::accept_state_from_rigid_body(const Real *const x_in, const Real *const u_in){
  ...
  segments[0].x[2] = x_in[2];
    ...
    void filament::fill_fourier_coeff_mats(){
        ...
        // By = matrix(3,5);
        // By(0,0) = -6.88571251e-02;
        // By(1,0) = 1.40053115e-01;
        // By(2,0) = -8.39821704e-02;
        // By(0,1) = 1.75026733e+00;
        // By(1,1) = -6.51431634e-01;
        // By(2,1) = 3.62277417e-01;
        // By(0,2) = -1.01303351e+00;
        // By(1,2) = -8.65827857e-01;
        // By(2,2) = -1.58616376e-01;
        // By(0,3) = -1.12759917e+00;
        // By(1,3) = 2.95666668e+00;
        // By(2,3) = -9.13972764e-01;
        // By(0,4) = 8.39003923e-01;
        // By(1,4) = -1.62385353e+00;
        // By(2,4) = 7.91146872e-01;

        // Bx = matrix(3,5);
        // Bx(0,0) = -4.41780194e-02;
        // Bx(1,0) = 1.46304327e-01;
        // Bx(2,0) = -1.64458120e-01;
        // Bx(0,1) = 3.50503214e-01;
        // Bx(1,1) = -1.57909531e+00;
        // Bx(2,1) = 1.95094118e+00;
        // Bx(0,2) = -1.40840290e+00;
        // Bx(1,2) = 4.57464020e+00;
        // Bx(2,2) = -5.92187134e+00;
        // Bx(0,3) = 1.35575514e+00;
        // Bx(1,3) = -4.65549102e+00;
        // Bx(2,3) = 6.70810317e+00;
        // Bx(0,4) = -2.73009417e-01;
        // Bx(1,4) = 1.48133031e+00;
        // Bx(2,4) = -2.55198829e+00;
    ...
    Real filament::platy_beat_tangent_angle(const Real s) const {
      ...
      Real shift_phase = phase - s/FIL_LENGTH*ZERO_VELOCITY_AVOIDANCE_LENGTH*2.0*PI;
      ...
      if (modphase < cutoff){
            ...
            return recovery_angle(s, modphase - cutoff) + s*shape_rotation_angle/FIL_LENGTH + PI/2.0;
        }
    }
    ...
    matrix filament::platy_beat_angle_deriv_integrand(const Real s) const {
      ...
      direction_integrand(0) = std::cos(platy_beat_tangent_angle(s))*s/FIL_LENGTH;
      direction_integrand(1) = -std::sin(platy_beat_tangent_angle(s))*s/FIL_LENGTH;
      direction_integrand(2) = 0.0;
...
void filament::initial_guess(const int nt, const Real *const x_in, const Real *const u_in){
  ...
  accept_state_from_rigid_body(x_in, u_in);
    ...
    // printf("vel_dir_phase set to zero\n");
    ...
    for (int n = 1; n < NSEG; n++){
        ...
        angle_deriv_integrand = R*angle_deriv_integrand;
