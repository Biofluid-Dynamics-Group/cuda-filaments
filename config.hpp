...
#define OUTPUT_FORCES true
  ...
  // 5 = Platynaereis style generic beat
    ...
    #define ZERO_VELOCITY_AVOIDANCE_LENGTH 0.75 // A value in (0,1), giving the maximum fraction of the cycle by which we shift the tangent angle curve to ensure the velocity cannot be zero everywhere along the filament at once.
